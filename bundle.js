...
var _decorators = __webpack_require__(342);

var _logger = __webpack_require__(344);
...
var friendsListTemplate = __webpack_require__(331);
var cyrillicToTranslit = __webpack_require__(348);
var jsCookie = __webpack_require__(349);
var toastr = __webpack_require__(350);

var contentBlock = document.querySelector('.content');
var unlistedFriendsListNode = document.querySelector('#all-friends ul');
var listedFriendsListNode = document.querySelector('#picked-friends ul');
var allFriendsArr = []; // array of full friends data
var idsList = []; // all friends ids arr
var listedIdsList = []; // listed friends ids arr
var unlistedFriendsSearchTerm = '';
var listedFriendsSearchTerm = '';
...
contentBlock.addEventListener('click', function (e) {
	if (e.target.classList[0] === 'add' || e.target.parentNode.parentNode.classList[0] === 'add' || e.target.parentNode.classList[0] === 'add') {
		...
		var elementToRemove = e.target.closest('li');
...
function setListenersForLists(ulList) {
	ulList.addEventListener('dragstart', function (e) {
		if (e.target.tagName === 'LI') {
			...
			var jsonTransferObj = JSON.stringify(transferObj);
...
async function vkInit(rigthAway) {
	try {
		...
		var response = await callAPI('friends.get', { fields: 'photo_50', order: 'name' });
		allFriendsArr = response.response.map(function (item) {
...
var Handlebars = __webpack_require__(332);
...
var _handlebarsRuntime = __webpack_require__(346);

var runtime = _interopRequireWildcard(_handlebarsRuntime);

var _handlebarsNoConflict = __webpack_require__(347);
...
var _helpersBlockHelperMissing = __webpack_require__(335);

var _helpersBlockHelperMissing2 = _interopRequireDefault(_helpersBlockHelperMissing);

var _helpersEach = __webpack_require__(336);

var _helpersEach2 = _interopRequireDefault(_helpersEach);

var _helpersHelperMissing = __webpack_require__(337);

var _helpersHelperMissing2 = _interopRequireDefault(_helpersHelperMissing);

var _helpersIf = __webpack_require__(338);

var _helpersIf2 = _interopRequireDefault(_helpersIf);

var _helpersLog = __webpack_require__(339);

var _helpersLog2 = _interopRequireDefault(_helpersLog);

var _helpersLookup = __webpack_require__(340);

var _helpersLookup2 = _interopRequireDefault(_helpersLookup);

var _helpersWith = __webpack_require__(341);
...
var _decoratorsInline = __webpack_require__(343);
...
/* global define */
(function (define) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(351)], __WEBPACK_AMD_DEFINE_RESULT__ = (function ($) {
        return (function () {
            var $container;
            var listener;
            var toastId = 0;
