...
var vkStart = function () {
	var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(rigthAway) {
		var response;
			...
			while (1) {
				switch (_context2.prev = _context2.next) {
					case 0:
						_context2.prev = 0;
						_context2.next = 3;
						return (0, _vkcore.vkInit)();

					case 3:
						response = _context2.sent;

						jsCookie.set('vk_auth', 'true', { expires: 1 });
						(0, _columns.getInitialData)(response);
									...
									switch (_context.prev = _context.next) {
										case 0:
											new _promise2.default(function (resolve, reject) {
												(0, _columns.columnsLayout)(friendsListsNodes);
												resolve();
											});
...
var _columns = __webpack_require__(205);

var _vkcore = __webpack_require__(224);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

__webpack_require__(225);

var jsCookie = __webpack_require__(427),
    toastr = __webpack_require__(428),
...
contentBlock.addEventListener('click', function (e) {
	if (e.target.classList[0] === 'add' || e.target.parentNode.parentNode.classList[0] === 'add' || e.target.parentNode.classList[0] === 'add' || e.target.classList[0] === 'remove' || e.target.parentNode.classList[0] === 'remove' || e.target.parentNode.parentNode.classList[0] === 'remove') {
		var elementToAdd = e.target.closest('li');
		var addRemove = elementToAdd.querySelector('span').classList[0];
		var userId = elementToAdd.dataset.id;
		(0, _columns.columnsLayout)(friendsListsNodes, addRemove, userId);
	}
});

// list item dnd
friendsListsNodes.forEach(function (ulList) {
	ulList.addEventListener('dragstart', function (e) {
		if (e.target.tagName === 'LI') {
			...
			var jsonTransferObj = (0, _stringify2.default)(transferObj);
			e.dataTransfer.setData('text/plain', jsonTransferObj);
		}
	});

	ulList.addEventListener('dragover', function (e) {
		e.preventDefault();
	});

	ulList.addEventListener('drop', function (e) {
		e.preventDefault();
		var dataObj = JSON.parse(e.dataTransfer.getData('text/plain'));
		var friendId = parseInt(dataObj.id);
		var listType = dataObj.type;
		var currentListType = e.currentTarget.parentNode.id;

		if (listType !== currentListType) {
			if (listType === 'all-friends') {
				(0, _columns.columnsLayout)(friendsListsNodes, 'add', friendId);
			} else {
				(0, _columns.columnsLayout)(friendsListsNodes, 'remove', friendId);
			}
		}
	});
});
...
// search fields
document.querySelector('.header-bottom').addEventListener('keyup', function (e) {
	if (e.target.id === 'search-all-friends') {
		(0, _columns.columnsLayout)(friendsListsNodes, 'allUsersSearch', e.target.value);
	} else if (e.target.id === 'search-picked-friends') {
		(0, _columns.columnsLayout)(friendsListsNodes, 'listedUsersSearch', e.target.value);
	}
});

// saving picked friends list
document.getElementById('savelist').addEventListener('click', function () {
	(0, _columns.saveToStorage)();
...
function changeAuthorised(removeAdd) {
	var elemsToEdit = [document.getElementById('filter'), document.getElementById('logo'), document.body];
	elemsToEdit.forEach(function (elem) {
		if (removeAdd) {
...
module.exports = !__webpack_require__(53) && !__webpack_require__(118)(function () {
...
exports.saveToStorage = exports.getInitialData = exports.columnsLayout = undefined;
...
var friendsListTemplate = __webpack_require__(206),
    cyrillicToTranslit = __webpack_require__(223);

var allFriendsArr = [],
    // array of full friends data
idsList = [],
    // all friends ids arr
listedIdsList = [],
    // listed friends ids arr
unlistedFriendsSearchTerm = '',
    listedFriendsSearchTerm = '';

var addListedId = function addListedId(id) {
	listedIdsList.push(parseInt(id));
};

var removeListedId = function removeListedId(id) {
...
var sortFriends = function sortFriends(elemFn) {
...
var sortFriendsBySearchTerm = function sortFriendsBySearchTerm(searchTerm) {
...
var getInitialData = function getInitialData(initData) {
	listedIdsList = localStorage.data ? JSON.parse(localStorage.data) : [];
	allFriendsArr = initData.map(function (item) {
		...
		return item;
	}).sort(sortFriends(function (elem) {
		return elem.last_name;
	}));

	idsList = allFriendsArr.map(function (item) {
		return item.uid;
	});
};

// Function builds up both lists and fires each time friends adding, removing or search occures 
var columnsLayout = function columnsLayout(friendsListsNodes) {
	var changed = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
	var elem = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : undefined;
	...
	var listedFriendsArr = [];
	var unlistedFriendsArr = [];

	// building up 2 arrays: list of listed and unlisted friends, 
	allFriendsArr.forEach(function (item) {
	...
	listedFriendsArr.sort(sortFriends(function (elem) {
		return listedIdsList.indexOf(elem.uid);
	}));
	...
	var unlistedFriendsHtmlList = friendsListTemplate({
		friends: unlistedFriendsArr
	});
	var listedFriendsHtmlList = friendsListTemplate({
...
var saveToStorage = function saveToStorage() {
	localStorage.data = (0, _stringify2.default)(listedIdsList);
};

exports.columnsLayout = columnsLayout;
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "	<li draggable=\"true\" data-id='"
    ...
    + "</p>\n		<span class=\""
    + alias4(((helper = (helper = helpers.moveClass || (depth0 != null ? depth0.moveClass : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"moveClass","hash":{},"data":data}) : helper)))
    + "\"><i class=\"fas fa-times\"></i></span>\n	</li>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1, helper, options;

  stack1 = ((helper = (helper = helpers.friends || (depth0 != null ? depth0.friends : depth0)) != null ? helper : helpers.helperMissing),(options={"name":"friends","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data}),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),options) : helper));
  if (!helpers.friends) { stack1 = helpers.blockHelperMissing.call(depth0,stack1,options)}
...
exports.logout = exports.vkInit = undefined;
...
var callAPI = function callAPI(method, params) {
    return new _promise2.default(function (resolve, reject) {
        ...
        return _regenerator2.default.wrap(function _callee$(_context) {
            while (1) {
                switch (_context.prev = _context.next) {
                    ...
                    case 2:
                        _context.next = 4;
                        return callAPI('friends.get', { fields: 'photo_50', order: 'name' });
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(12)(proto, TO_PRIMITIVE, __webpack_require__(309));
...
/* global define */
(function (define) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(429)], __WEBPACK_AMD_DEFINE_RESULT__ = (function ($) {
        return (function () {
            var $container;
            var listener;
            var toastId = 0;
